...
export default class MineEmployeeEdit extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            password: '',
            rePassword: '',
            iscall: params.item ? params.item.iscall : '1',
            canPress: true,
            canBack: false,
        }
    ...
    submit = () => {
        let {id, name, mobile, password, rePassword, iscall, canPress} = this.state;
        let url = NetApi.staffEdit;
        let data = {
            id: id,
            name: name,
            mobile: mobile,
            ...
            <View style={styles.container}>
                ...
                <KeyboardAwareScrollView keyboardShouldPersistTaps={'always'} style={[GlobalStyles.hasFix1edContainer, styles.scrollV1iewContainer]}>
                     <CustomKeyboard.AwareCusKeyBoardScrollView>
                        ...
                        <View style={[GlobalStyles.fixedBtnV2iew, styles.orderDetalBtnView]}>
                            <TouchableOpacity
